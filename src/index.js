...
document.addEventListener("DOMContentLoaded" ,  () =>){
    ...
    paragraph[2].innerHTML = "I know how to use the sytle method to change the style of an element in the DOM";
    ...
    paragraph[4].innerHTML = "Yes , i did it ! I manipulated the DOM and styled my element😍😍😍";}
        ...
        console.error("Error: Not enough paragraph element found.");
    }